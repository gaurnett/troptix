  ...
  async function initializeStripeDetails() {
    createPaymentIntent.mutate({ checkout }, {
      onSuccess: (data) => {
        ...
        createOrder.mutate({ checkout, paymentId, customerId, userId: user.id, jwtToken: user.jwtToken }, {
          onSuccess: (data) => {
                          ...
                          return (
                            <List.Item
                              ...
                              <div className='w-full flex my-4'>
                                ...
                                <div className='ml-4'>
                                  <div className='ml-4'>
                                    <div className='text-base text-end'>{getFormattedCurrency(subtotal * quantitySelected)}</div>
                                  </div>
                                </div>
                              </div>
                            </List.Item>
