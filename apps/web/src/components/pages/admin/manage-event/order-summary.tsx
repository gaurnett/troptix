          ...
          <div>
            ...
            {isComplementary ? (
              ...
              <div className="text-base">
                {summary.quantitySold}/{summary.quantity}
              </div>
            )}
          </div>
        </div>
            ...
            <div>
              <div className="flex flex-wrap mb-4 mt-8">
                <div className="w-full px-3">
                  <label className="text-xl md:text-1xl font-medium text-sm mb-1">
                    Ticket Summary
                  </label>
                  <List
                    ...
                    renderItem={(summary: any) => (
                      <List.Item>{TicketSoldItem(summary[1])}</List.Item>
                    )}
                  />
                </div>
              </div>
