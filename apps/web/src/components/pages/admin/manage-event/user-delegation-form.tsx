...
export default function UserDelegationForm({
  onClose,
  selectedUser,
  setSelectedUser,
  saveUser,
  ...
  return (
    <div className="md:max-w-md">
      <Form name="user-delegation-form" onFinish={saveUser}>
        <h3
            ...
            <Select
              ...
              options={[
                { label: 'Owner', value: DelegatedAccess.OWNER },
                {
                  ...
                  value: DelegatedAccess.TICKET_SCANNER,
                },
              ]}
            />
          </div>
        ...
        <div className="flex flex-wrap -mx-3 mb-4 mt-4">
          <div className="px-3">
            <Button
              onClick={onClose}
              className="px-8 py-6 shadow-md items-center justify-center font-medium inline-flex"
            >
              Discard
            </Button>
          </div>
