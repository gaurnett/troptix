...
import { GetUsersRequest, getUsers, GetUsersType, putUsers, PutUsersType } from 'troptix-api';
...
export default function AccountPage() {
  ...
  async function onFinish(values: any) {
    ...
    if (adminUser.name !== user.name) {
      ...
      await updateProfile(currentUser, { displayName: adminUser.name });
    }
      ...
      <div className="mx-4">
        ...
        {!isFetchingUser
          ...
          <Form
            ...
            className="mx-4">
            <h2 className="text-2xl md:text-3xl font-extrabold leading-tighter tracking-tighter mb-4 mt-4" data-aos="zoom-y-out">Contact Information</h2>
            ...
            <div className="flex flex-wrap -mx-3 mb-4">
              <div className="w-full px-3">
                <CustomInput value={adminUser.email} name={"email"} id={"email"} label={"Email"} type={"text"} placeholder={"johndoe@gmail.com"} handleChange={handleChange} required={true} disabled={true} />
              </div>
            </div>
            <div className="flex flex-wrap -mx-3 mb-4">
              <div className="w-full px-3">
                <CustomInput value={adminUser.telephoneNumber} name={"telephoneNumber"} id={"telephoneNumber"} label={"Telephone Number"} type={"text"} placeholder={"123456789"} handleChange={handleChange} />
              </div>
            </div>

            <h2 className="text-2xl md:text-3xl font-extrabold leading-tighter tracking-tighter mb-4" data-aos="zoom-y-out">Billing Address</h2>

            <div className="flex flex-wrap -mx-3 mb-4">
              <div className="w-full px-3">
                <CustomInput value={adminUser.billingAddress1} name={"billingAddress1"} id={"billingAddress1"} label={"Address"} type={"text"} placeholder={"185 Kings Street"} handleChange={handleChange} />
              </div>
            </div>
            <div className="flex flex-wrap -mx-3 mb-4">
              <div className="w-full px-3">
                <CustomInput value={adminUser.billingAddress2} name={"billingAddress2"} id={"billingAddress2"} label={"Address 2"} type={"text"} placeholder={""} handleChange={handleChange} />
              </div>
            </div>
            <div className="md:flex md:justify-between">
              <div className="mb-4 md:mr-4 w-full">
                <CustomInput value={adminUser.billingCity} name={"billingCity"} id={"billingCity"} label={"City"} type={"text"} placeholder={"Kingston"} handleChange={handleChange} />
              </div>
              <div className="mb-4 md:ml-4 w-full">
                <CustomInput value={adminUser.billingZip} name={"billingZip"} id={"billingZip"} label={"Zip/Postal Code"} type={"text"} placeholder={"12345"} handleChange={handleChange} />
              </div>
            </div>
            <div className="md:flex md:justify-between">
              <div className="mb-4 md:mr-4 w-full">
                <CustomInput value={adminUser.billingState} name={"billingState"} id={"billingState"} label={"State/Parish"} type={"text"} placeholder={"Kingston"} handleChange={handleChange} />
              </div>
              <div className="mb-4 md:ml-4 w-full">
                <CustomInput value={adminUser.billingCountry} name={"billingCountry"} id={"billingCountry"} label={"Country"} type={"text"} placeholder={"Jamaica"} handleChange={handleChange} />
              </div>
            </div>
