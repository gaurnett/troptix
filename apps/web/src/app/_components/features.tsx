export default function Features() {
  ...
  return (
    <section className="relative bg-muted/30">
      {/* Section background */}
      <div
        className="absolute inset-0 bg-gradient-to-b from-background to-muted/50 pointer-events-none"
        aria-hidden="true"
      ></div>
      <div
        className="absolute inset-0 top-1/2 md:mt-24 lg:mt-0 bg-gradient-to-b from-muted/50 to-background pointer-events-none"
        aria-hidden="true"
      ></div>
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4 text-foreground">Explore our solutions</h2>
...
function FeatureTile({ title, description, icon }) {
  return (
    <div className="relative flex flex-col items-center p-6 bg-card rounded-lg shadow-md border border-border hover:shadow-lg transition-shadow">
      {icon}
      <h4 className="text-xl font-bold leading-snug tracking-tight mb-1 text-card-foreground">
        {title}
      </h4>
    ...
    >
      <g fill="none" fillRule="evenodd">
        ...
        <g strokeWidth="2" strokeLinecap="square">
          ...
          />
          <path
            className="stroke-current text-primary/60"
    ...
    >
      <g fill="none" fillRule="evenodd">
        ...
        <g strokeWidth="2">
          ...
          />
          <path className="stroke-current text-primary/60" d="M36.571 32H40" />
          <path
            className="stroke-current text-primary-foreground"
            d="M24 32h3.429"
            strokeLinecap="square"
