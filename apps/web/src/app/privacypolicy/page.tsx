export default function PrivacyPolicy() {
  return (
    <div className="mt-32 mb-8 w-full md:max-w-3xl mx-auto">
      ...
      <div data-custom-class="body">{policy()}</div>
    </div>
  );
}
  ...
  return (
    <div className="text-base mx-6">
      ...
      <div style={{ lineHeight: '1.5' }}>
        This privacy notice for TechBrewery Limited {'('}&quot;we,&quot;
        &quot;us,&quot; or &quot;our&quot;{') '}
      ...
      <div style={{ lineHeight: '1.5' }}>
        ...
        <a className="underline" data-custom-class="link" href="#toc">
          <strong>
      ...
      <div style={{ lineHeight: '1.5' }}>
        ...
        about{' '}
        <a className="underline" data-custom-class="link" href="#personalinfo">
      ...
      <div style={{ lineHeight: '1.5' }}>
        ...
        <a className="underline" data-custom-class="link" href="#infouse">
      ...
      <div style={{ lineHeight: '1.5' }}>
        ...
        <a className="underline" data-custom-class="link" href="#whoshare">
      ...
      <div style={{ lineHeight: '1.5' }}>
        ...
        <a className="underline" data-custom-class="link" href="#privacyrights">
          your privacy rights
        </a>
        .
      </div>
      ...
      <div style={{ lineHeight: '1.5' }}>
        ...
        <a
          className="underline"
          data-custom-class="link"
          href="https://app.termly.io/notify/6d64792c-d1d7-472b-b835-c1ed4290f673"
      ...
      <div style={{ lineHeight: '1.5' }}>
        <a className="underline" data-custom-class="link" href="#infocollect">
      ...
      <div style={{ lineHeight: '1.5' }}>
        <a className="underline" data-custom-class="link" href="#legalbases">
      ...
      <div style={{ lineHeight: '1.5' }}>
        <a className="underline" data-custom-class="link" href="#cookies">
          5. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?
        </a>
      </div>
      <div style={{ lineHeight: '1.5' }}>
        <a className="underline" data-custom-class="link" href="#sociallogins">
          6. HOW DO WE HANDLE YOUR SOCIAL LOGINS?
        </a>
      </div>
      <div style={{ lineHeight: '1.5' }}>
        <a className="underline" data-custom-class="link" href="#inforetain">
      ...
      <div style={{ lineHeight: '1.5' }}>
        <a className="underline" data-custom-class="link" href="#DNT">
          9. CONTROLS FOR DO-NOT-TRACK FEATURES
        </a>
      </div>
      <div style={{ lineHeight: '1.5' }}>
        <a className="underline" data-custom-class="link" href="#uslaws">
      ...
      <div style={{ lineHeight: '1.5' }}>
        <a className="underline" data-custom-class="link" href="#policyupdates">
          11. DO WE MAKE UPDATES TO THIS NOTICE?
        </a>
      </div>
      <div style={{ lineHeight: '1.5' }}>
        <a className="underline" data-custom-class="link" href="#contact">
          12. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?
        </a>
      </div>
      <div style={{ lineHeight: '1.5' }}>
        <a className="underline" data-custom-class="link" href="#request">
      ...
      <div style={{ lineHeight: '1.5' }}>
        ...
        All payment data is stored by Stripe. You may find their privacy notice
        link(s) here:
        <div className="question">
          <a
            className="underline"
            href="https://assets.ctfassets.net/fzn2n1nzq965/4OJzjP0xi7pJVpwE6g7adR/63879e15ba95e3591935c50d07b16f88/Privacy_Policy_-_January_24_2023.pdf"
            target="_blank"
            data-custom-class="link"
          >
            https://assets.ctfassets.net/fzn2n1nzq965/4OJzjP0xi7pJVpwE6g7adR/63879e15ba95e3591935c50d07b16f88/Privacy_Policy_-_January_24_2023.pdf
          </a>
        </div>
      </div>
      <div style={{ lineHeight: '1.5' }}>
      ...
      <div style={{ fontSize: '15px', lineHeight: '1.5' }}></div>
      <ul>
        <li className="list-disc" style={{ lineHeight: '1.5' }}>
      ...
      <ul>
        <li className="list-disc" style={{ lineHeight: '1.5' }}>
          ...
          <a className="underline" href="#privacyrights">
      ...
      <div style={{ lineHeight: '1.5' }}>
        ...
        <div style={{ lineHeight: '1.5' }}>
          ...
          <em>
            <em></em>In some regions, such as Canada, you have rights that allow
            you greater access to and control over your personal information.
            <em></em> You may review, change, or terminate your account at any
            time.
          </em>
        </div>
        <div style={{ lineHeight: '1.5' }}>
        ...
        <table style={{ width: '100%' }}>
          <tbody>
            ...
            <tr>
              ...
              >
                <div style={{ lineHeight: '1.5' }}>A. Identifiers</div>
              </td>
              <td
                style={{
                  width: '51.4385%',
              ...
              >
                ...
                <div style={{ lineHeight: '1.5' }}>
                  <div className="block-component"></div>YES
                  <div className="else-block"></div>
                </div>
                <div style={{ lineHeight: '1.5' }}>
                  <br />
              ...
              >
                ...
                <div style={{ lineHeight: '1.5' }}>
                  <div className="forloop-component">
                    <div className="block-component">YES</div>
                  </div>
                </div>
                <div style={{ lineHeight: '1.5' }}>
                  <br />
        ...
        <table style={{ width: '100%' }}>
          <tbody>
            ...
            <tr>
              ...
              >
                <div style={{ lineHeight: '1.5' }}>G. Geolocation data</div>
              </td>
              <td
                style={{
                  width: '51.4385%',
              ...
              >
                <div style={{ lineHeight: '1.5' }}>Device location</div>
              </td>
              <td
                style={{
                  width: '14.9084%',
            ...
            <tr>
              ...
              >
                ...
                >
                  <div className="block-component"></div>NO
                  <div className="statement-end-if-in-editor"></div>
                </div>
                <div data-empty="true" style={{ textAlign: 'center' }}>
                  <br />
        ...
        <div style={{ lineHeight: '1.5' }}>
          ...
          <div style={{ lineHeight: '1.5' }}>
            ...
            <div className="block-component"></div>&quot;Shine The Light&quot;
          ...
          <div style={{ lineHeight: '1.5' }}>
            We do not process consumer&pos;s sensitive personal information.
          </div>
          <div style={{ lineHeight: '1.5' }}>
            <br />
          </div>
          ...
          <div style={{ lineHeight: '1.5' }}>
            ...
            , by email at info@usetroptix.com, or by referring to the contact
          ...
          <div data-custom-class="body_text" style={{ lineHeight: '1.5' }}>
            To submit a request to exercise theserights described above, please
            email info@troptix.com or submit a{' '}
            <a
              className="underline"
              data-custom-class="link"
              href="https://app.termly.io/notify/6d64792c-d1d7-472b-b835-c1ed4290f673"
          ...
          <div style={{ lineHeight: '1.5' }}>
            ...
            appeal our decision, please email us at info@troptix.com. Within
          ...
          <ul>
            <li className="list-disc" style={{ lineHeight: '1.4' }}>
              Right to be informed whether or not we are processing your
              personal data
            </li>
          </ul>
          <div style={{ lineHeight: '1.4' }}></div>
          <ul>
            <li className="list-disc" style={{ lineHeight: '1.4' }}>
              Right to access your personal data
            </li>
          ...
          <div style={{ lineHeight: '1.5' }}>
            You may contact us by email at info@troptix.com or submit a{' '}
            <a
              className="underline"
              data-custom-class="link"
              href="https://app.termly.io/notify/6d64792c-d1d7-472b-b835-c1ed4290f673"
          ...
          <div style={{ lineHeight: '1.5' }}>
            ...
            our decision, please email us at info@troptix.com . Within sixty
          ...
          <div style={{ lineHeight: '1.5' }}>
            <div className="question">TechBrewery Limited</div>
          </div>
          <div style={{ lineHeight: '1.5' }}>
