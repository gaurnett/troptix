  ...
  return (
    <div className="text-base mx-6">
      ...
      <p>
        ...
        of Tech Brewery LLC&apos;s Website, located at{' '}
        <a
          className="underline"
      ...
      <p>
        ...
        conditions. Do not continue to use TropTix if you do not agree to take
        all of the terms and conditions stated on this page.
      </p>
      <br />
      <p>
        The following terminology applies to these Terms and Conditions, Privacy
        Statement and Disclaimer Notice and all Agreements: &quot;lient&quot;,
      ...
      <p>
        We employ the use of cookies. By accessing TropTix, you agreed to use
        cookies in agreement with the Tech Brewery LLC&apos;s Privacy Policy.{' '}
      </p>
      ...
      <p>
        Unless otherwise stated, Tech Brewery LLC and/or its licensors own the
        intellectual property rights for all material on TropTix. All
        intellectual property rights are reserved. You may access this from
        TropTix for your own personal use subjected to restrictions set in these
      ...
      <ul>
        ...
        <li className="list-disc">
          Sell, rent or sub-license material from TropTix
        </li>
        <li className="list-disc">
          Reproduce, duplicate or copy material from TropTix
        </li>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. Tech
        Brewery LLC does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Tech Brewery LLC,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Tech Brewery LLC
      ...
      <br />
      <p>
        Tech Brewery LLC reserves the right to monitor all Comments and to
      ...
      <br />
      <p>
        You hereby grant Tech Brewery LLC a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Tech Brewery LLC; and (d) the
      ...
      <p>
        ...
        e-mail to Tech Brewery LLC. Please include your name, your organization
      ...
      <br />
      <p>
        No use of Tech Brewery LLC&apos;s logo or other artwork will be allowed
