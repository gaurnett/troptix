  ...
  return (
    ...
    >
      ...
      <Dialog
        width={300}
        containerStyle={{
          backgroundColor: `${dialogData.scanSucceeded ? Colors.green50 : Colors.red50}`,
          borderRadius: 8,
        }}
        visible={showDialog}
        ...
        <View marginV-16 marginH-8>
          {dialogData.scanSucceeded ? (
            <View margin-4>
              ...
              <Text center marginT-8 text70 $textDefault>
                {dialogData.ticketName}
              </Text>
              <Text marginT-8 marginB-8 center text90 $textDefault>
            ...
            <>
              {!dialogData.ticketName ? (
                <View>
                  ...
                  <Text marginT-8 marginB-8 center text70 $textDefault>
                    This ticket is not valid for {event.name}
                  </Text>
                </View>
              ) : (
                <View>
