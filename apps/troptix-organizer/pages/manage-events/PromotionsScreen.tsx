      ...
      [
        ...
        },
        {
          ...
          onPress: () => {
            setPromotions(
              promotions.filter(
                (promotion) => promotion.id !== deletedPromotion.id
              )
            );
          },
        },
    ...
    return _.map(promotions, (promotion, i) => {
      return (
        <View key={i} marginT-16 row>
          <View flex>{PromotionItem(promotion, i)}</View>
            ...
            >
              <View>
                <Text
                  ...
                  $textDefault
                >
                  Add promotion codes that will give discounted prices on your
                  tickets.
                </Text>
              </View>
              <View>
          ...
          <View marginB-16>
            <FloatingButton
              ...
              button={{
                label: 'Add Promotion',
                onPress: () =>
                  openAddPromotionPage(new Promotion(eventObject.id)),
              }}
